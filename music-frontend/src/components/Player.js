...
export default function Player() {
  ...
  return (
    <>
      {/* --- MOBILE VIEW: Native Player --- */}
      <div className="fixed bottom-0 left-0 w-full z-[100] md:hidden bg-[#1B3C53] border-t border-white/10 p-3 pb-safe flex flex-col gap-3 shadow-2xl">
        {/* Track Info */}
        ...
        <audio
          ...
          style={{ filter: 'invert(1) hue-rotate(180deg)' }} // Dark mode hack for native player
        />
      </div>

      {/* --- DESKTOP VIEW: Custom Player --- */}
      <div className="hidden md:grid relative h-24 bg-brand-dark/95 backdrop-blur-xl border-t border-white/5 px-4 grid-cols-3 items-center z-50 select-none shadow-2xl">
